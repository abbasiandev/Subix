...
WELCOME_TEXT = (
    ...
    "سابیکس، پلتفرم پیشرفته ارائه و فروش "
    "اشتراک‌های پرمیوم هوش مصنوعی است.\n\n"
    "✨ <b>امکانات سابیکس:</b>\n"
    "🛍️ خرید آسان اشتراک‌های AI\n"
    "⚡ فعال‌سازی سریع (کمتر از 5 دقیقه)\n"
    "💳 پرداخت امن و مطمئن\n"
    "📞 پشتیبانی 24/7\n\n"
    "➕ برای شروع، از دکمه‌های زیر استفاده کنید.\n\n"
    "💡 نکته: بارگذاری اولیه ممکن است چند لحظه طول بکشد. "
    "صبور باشید تا صفحه کاملاً بارگذاری شود."
)
...
def handle_update(update: dict) -> None:
    ...
    if text.startswith("/start"):
        ...
        return
    try:
        send_message(chat_id, "از دکمه‌های زیر استفاده کنید 👇", reply_markup=kb)
    except Exception:
