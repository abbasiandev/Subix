...
const PRODUCT_CONTENT: Record<string, {
  ...
  Claude: {
    description: `Claude Pro اشتراک پیشرفته دستیار هوش مصنوعی Anthropic است که با تمرکز بر ایمنی، دقت و قابلیت درک عمیق متن طراحی شده است. Claude در تحلیل اسناد طولانی، نوشتن محتوای خلاقانه و کدنویسی عملکرد فوق‌العاده‌ای دارد.`,
    features: [
      "دسترسی به مدل Claude 3 Opus",
      "تحلیل اسناد تا 100 هزار کلمه",
      "دقت بالا در درک زمینه",
      "امکان آپلود فایل PDF و تحلیل آن",
      "کدنویسی پیشرفته",
      "نوشتن محتوای طولانی",
      "اولویت سرعت پاسخ",
      "5 برابر استفاده بیشتر نسبت به نسخه رایگان",
    ],
    howToUse: [
      "پس از خرید، اطلاعات ورود به حساب Claude را دریافت کنید",
      "به سایت claude.ai بروید",
      "روی Login کلیک و ایمیل دریافتی را وارد کنید",
      "کد تأیید ارسال شده به ایمیل را وارد کنید",
      "از Claude Pro استفاده کنید",
    ],
    faqs: [
      {
        q: "تفاوت Claude با ChatGPT چیست؟",
        a: "Claude در تحلیل اسناد طولانی و درک عمیق متن قوی‌تر است و پاسخ‌های دقیق‌تری می‌دهد.",
      },
      {
        q: "آیا می‌توانم فایل آپلود کنم؟",
        a: "بله، Claude Pro از آپلود و تحلیل فایل‌های PDF، Word و متنی پشتیبانی می‌کند.",
      },
      {
        q: "محدودیت طول پیام چقدر است؟",
        a: "Claude Pro می‌تواند متن‌های تا 100 هزار کلمه را پردازش کند.",
      },
    ],
  },
  Spotify: {
